...
declare namespace __React {
    ...
    function createElement<P>(type: ComponentClass<P> | SFC<P>, props?: P & Attributes, ...children: ReactNode[]): ReactElement<P>;
     ...
     */
    type ClassType<P, T extends Component<P, ComponentState>, C extends ComponentClass<P>> = C & (new () => T) & (new () => { props: P });
